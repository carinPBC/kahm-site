    ...
    fetch(API + '/api/ads/kahm')
      ...
      .then(function(d) {
        ...
        function buildBanner() {
          ...
          if (ad.link_url) {
            banner.innerHTML = '<a id="kahm-ad-link" href="/track?station=kahm&type=ad&label='+encodeURIComponent(ad.label||ad.link_url||'')+'&url='+encodeURIComponent(ad.link_url)+'" target="_blank" rel="noopener" style="display:inline-block;">'
        ...
        function showAd(idx) {
          ...
          if (img) img.src = src;
          if (link) link.href = ad.link_url ? '/track?station=kahm&type=ad&label='+encodeURIComponent(ad.label||ad.link_url||'')+'&url='+encodeURIComponent(ad.link_url) : '#';
        }
